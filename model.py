...
class TextNet(BasicModule):
    def __init__(self, y_dim, bit):
        ...
        self.LAYER1_NODE = 8192
        self.bit = bit

        # ful-conv layer
        self.conv1 = nn.Conv2d(1, self.LAYER1_NODE, kernel_size=(y_dim, 1), stride=(1, 1))
        self.conv2 = nn.Conv2d(self.LAYER1_NODE, bit, kernel_size=1, stride=(1, 1))
